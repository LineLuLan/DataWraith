...
See `docs/BuildPlan_AllPhases.md`, `docs/BuildPlan_Phase2.md`, and
`docs/BuildPlan_Phase3.md` for file-level execution order, acceptance commands,
and cross-phase constraints.
